...
const About = function () {
        ...
        var el = document.querySelector(".about");
            ...
            document.addEventListener("scroll", e => {
                ...
                (scrolledPixels <= 0) && (
                    ...
                    [].forEach.call(document.querySelectorAll(".about--title__line"), el => el.classList.remove(style.show, style.hide)),
                ...
                (scrolledPixels > 0) && (
                    ...
                    [].forEach.call(document.querySelectorAll(".about--title__line"), el => (el.classList.add(style.show), el.classList.remove(style.hide))),
                ...
                (scrolledPixels >= offset) && (
                    [].forEach.call(document.querySelectorAll(".about--title__line"), el => el.classList.add(style.hide)),
                    document.querySelector("." + style.animation).classList.remove(style["show--animation"]),
                    document.querySelector("." + style["about--media"]).classList.remove(style["show--about--media"]),
                    gsap.to("." + style["paragraph-container"] + " > .inner > p", { y: document.querySelector("." + style["paragraph-container"]).clientHeight - (scrolledTextPercentage/100) * document.querySelector("." + style["paragraph-container"] + " > .inner").clientHeight, duration: .4 })
                ),
                /**
    ...
    return (
        <section className="about" style={{height: (window.innerHeight * 6) + "px", position: "relative"}}>
            <div className="about--content vp">
                ...
                <div className={style["paragraph-container"]}>
                    <div className="inner">
                        <p>Een jong en creatief duo die jouw online aanwezigheid een <em className="pink">boost</em> geeft. Van <em className="pink">websites</em> tot <em className="pink">web software</em>, wij doen het.</p>

                        <p>Vanaf het moment dat ons bedrijf werd opgericht hebben we onze clienten geholpen met het oplossen van <em className="pink">complexe automatisering</em> en <em className="pink">memorabele</em> online identiteiten neer te zetten.</p>
                    </div>
                </div>
